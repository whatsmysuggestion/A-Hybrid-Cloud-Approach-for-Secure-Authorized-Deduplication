...
public class ViewRemoteUsers2 extends JFrame implements ActionListener
{
...
setTitle("Remote User Details::A Hybrid Cloud Approach for Secure Authorized Deduplication");
c= getContentPane();
	 ...
	 heading.addElement("Cloud Server");
			  ...
			  DBCon db = new DBCon();
				Connection con = db.getConnection();
	             ...
	             String query = "SELECT * From  remote where cloudname='CS2'";
