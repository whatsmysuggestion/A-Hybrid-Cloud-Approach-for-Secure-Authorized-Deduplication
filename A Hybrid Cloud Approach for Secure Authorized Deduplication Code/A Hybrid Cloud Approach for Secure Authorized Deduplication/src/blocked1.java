...
public class blocked1 extends JFrame implements ActionListener
{
...
setTitle("Cloud Server1::Blocked Owner Details");
c= getContentPane();
	 ...
	 heading.addElement("Cloud Server");
			  ...
			  DBCon db = new DBCon();
				Connection con = db.getConnection();
	             ...
	             String query = "SELECT * From  blocker where cloudname='CS1'";
